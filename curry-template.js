function curryTemplate(source, defaults) {
  defaults = defaults || {}
        ...
        if (Array.isArray(source)) { // Array
          return function (params) {
            return source.map(function (k) {
              return curryTemplate(k, defaults)(params)
            })
          }
        }
        return function (params) { // Object, RegExp, Function
          for (var key in source) {
            if (source.hasOwnProperty(key)) {
              source[key] = curryTemplate(source[key], defaults)(params)
            }
          }
          return source
        }
...
if (typeof module !== 'undefined') module.exports = curryTemplate